...
using TrackMagic_CheckInOut_aspdotnetcore;

namespace TrackMagic_CheckInOut_aspdotnetcore.Pages.WebCamTest
{
    public class WebCamController : PageModel
    {

        private readonly DatabaseContext _context;
        private readonly IWebHostEnvironment _environment;

        public WebCamController(IWebHostEnvironment hostingEnvironment, DatabaseContext context)
        {
                ...
                if (files != null)
                {
                    foreach (var file in files)
                    {
                        if (file.Length > 0)
                        {
                            ...
                            {
                                // Storing Image in Folder
                                //FIXME: StoreInDatabase(imageBytes);
                            }

                        }
                    }

                    //bool jsonString = (imageBytes != null);
                    //return Json(true);
